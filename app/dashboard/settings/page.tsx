            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">How often to update threat data</p>
                </div>
                <Select
                  value={settings.refreshRate}
                  onValueChange={(value) => setSettings({ ...settings, refreshRate: value })}
                >
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Automatically block detected malicious IPs</p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Sensitivity of threat detection</p>
                </div>
                <Select
                  value={settings.threatLevel}
                  onValueChange={(value) => setSettings({ ...settings, threatLevel: value })}
                >
                  <SelectTrigger className="w-32">
                    <SelectValue />
                  </SelectTrigger>
